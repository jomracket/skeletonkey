...
for %%A in ("C:\Download\Emulators\Mame") do SET EMUL=%%~A&if not exist "%%~A" echo.NO EMULATOR>RJerror.log&EXIT /b
for %%A in ("C:\Download\Emulators\Mame\Mame32.exe") do SET EMUZ=%%~nA&if not exist "%%~A" echo.NO EMULATOR EXE>RJerror.log&EXIT /b
...
[INIVARS]
EMUL="C:\Download\Emulators\Mame"
EMUZ="Mame32.exe"
ANTIMIC=""
XPADDER=""
PLYRN1=""
...
%LAUNCH% "%EMUL%\%EMUZ%.exe" nes -cart "%GAMDIR%\%ROMF%"
%CCMDY%
%RLOC%popd
