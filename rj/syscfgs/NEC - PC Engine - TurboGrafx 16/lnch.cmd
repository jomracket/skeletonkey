...
for %%A in ("C:\Download\Emulators\Mednafen") do SET EMUL=%%~A&if not exist "%%~A" echo.NO EMULATOR>RJerror.log&EXIT /b
for %%A in ("C:\Download\Emulators\Mednafen\Mednafen.exe") do SET EMUZ=%%~nA&if not exist "%%~A" echo.NO EMULATOR EXE>RJerror.log&EXIT /b
...
[INIVARS]
EMUL="C:\Download\Emulators\Mednafen"
EMUZ="Mednafen.exe"
ANTIMIC=""
XPADDER=""
PLYRN1=""
