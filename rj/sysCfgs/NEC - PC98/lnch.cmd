...
for /f "delims=" %%a in ('dir /B /A-D "*dsk" "*.ima" "*.img" "*.ufi" "*.360" "*.hdm" "*.fdi" "*.fdd" "*.dcp" "*.dcu" "*.dip" "*.nfd" "*.d77" "*.d88" "*.1dd" "*.dfi" "*.hfe" "*.imd" "*.ipf" "*.mfi" "*.mfm" "*.td0" "*.cqm" "*.cqi" "*.zip"') do (
set ROMF=%%~a
set ROM=%%~na
set ROMX=%%~xa
set ROMFN=%%~nxa
