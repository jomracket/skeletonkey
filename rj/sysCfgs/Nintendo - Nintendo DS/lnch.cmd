...
for %%A in ("C:\Emulators\DesMume") do SET EMUL=%%~A&if not exist "%%~A" echo.NO EMULATOR>RJerror.log&EXIT /b
for %%A in ("C:\Emulators\DesMume\DesMume-x64.exe") do SET EMUZ=%%~nA&if not exist "%%~A" echo.NO EMULATOR EXE>RJerror.log&EXIT /b
...
[INIVARS]
EMUL="C:\Emulators\DesMume"
EMUZ="DesMume-x64.exe"
GAMNAM="[GAMNAM]"
...
%LAUNCH% "%EMUL%\%EMUZ%.exe" --windowed-fullscreen "%GAMDIR%\%ROMF%"
%CCMDY%
%RLOC%popd
