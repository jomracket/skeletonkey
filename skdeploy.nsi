...
Icon "E:\skeletonkey\install.ico"
OutFile "E:\DVLP\skeletonkey-installer.exe"
...
LicenseData "E:\skeletonkey\ReadMe.md"
...
Section "" ; empty string makes it hidden, so would starting with -
  ...
  File "E:\skeletonkey\skeletonKey.exe"
  
  ;File "E:\skeletonkey\Portable.bat"
  ;File "E:\skeletonkey\*.set"
  ;File "E:\skeletonkey\*.ttf"
  ;File "E:\skeletonkey\*.html"
  ;File "E:\skeletonkey\*.png"
  ;File "E:\skeletonkey\*.ico"
  ;File "E:\skeletonkey\BSL.ahk"
  ;File "E:\skeletonkey\SKey-Deploy.ahk"
  ;File "E:\skeletonkey\skeletonkey.ahk"
  ;File "E:\skeletonkey\*.exe"
  ;SetOutPath $INSTDIR\gam
  ;File "E:\skeletonkey\gam\*.gam"
  ;SetOutPath $INSTDIR\joyImg
  ;File "E:\skeletonkey\joyImg\*.png"
  ;SetOutPath $INSTDIR\rj\joyCfgs
  ;File /r "E:\skeletonkey\rj\joyCfgs"
  ;SetOutPath $INSTDIR\rj\emuCfgs
  ;File /r "E:\skeletonkey\rj\emuCfgs"
  ;SetOutPath $INSTDIR\rj\scrapeArt
  ;File "E:\skeletonkey\rj\scrapeart\supported.set"
  ;;File "E:\skeletonkey\rj\scrapeart\*.7z"
  ;SetOutPath $INSTDIR\rj\KODI\AEL
  ;File "E:\skeletonkey\rj\KODI\AEL\*.set"
  ;SetOutPath $INSTDIR\rj\ES
  ;File "E:\skeletonkey\rj\ES\*.set"
  ;SetOutPath $INSTDIR
